...
class CRUDUser(CRUDBase[models.User, schemas.UserCreate, schemas.UserUpdate]):
    ...
    def create(cls, db: Session, *, obj_in: schemas.UserCreate) -> models.User:
        ...
        new_user = models.User(
            ...
            role=models.UserRole.ADMIN,          # Rôle par défaut ADMIN (à adapter selon besoin)
            login=obj_in.login,
    ...
    def get_many(
        ...
        # Récupère une liste paginée d'utilisateurs filtrés par rôle et non supprimés
        record_query = db.query(models.User).filter(
            models.User.is_deleted == False,
